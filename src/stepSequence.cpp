...
stepSequence::stepSequence()
  :sequenceName("Default Sequence Name")
  ,sequenceType("synth part")
  ,muted(0)
  ,midiChannel(0)
  ,selectedStep(-1)
  ,drumSequence(0)
...
const std::string stepSequence::getSequenceName() {
  return sequenceName;
}

const std::string stepSequence::getSequenceType() {
  return sequenceType;
}
...
void stepSequence::setSequenceName(const std::string name) {
  //TODO: using QString for brain-dead simplicity, but maybe use a char* for non-Qt portability.
  sequenceName=name;
}

void stepSequence::setSequenceType(const std::string type) {
  //TODO: using QString for brain-dead simplicity, but maybe use a char* for non-Qt portability.
  sequenceType=type;
}
...
int stepPattern::addSequence(const std::string type, const std::string name, int drumNote) {
